    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(blank=True, choices=[(1, 'Male'), (2, 'Female'), (3, 'Other')], db_index=True, null=True)),
                ...
                ('education', models.IntegerField(blank=True, choices=[(1, 'High School'), (2, 'Associate Degree'), (3, "Bachelor's Degree"), (4, "Master's Degree"), (5, 'PhD'), (6, 'Other')], null=True)),
                ('profession', models.CharField(blank=True, max_length=100, null=True)),
                ('english_first_name', models.CharField(blank=True, db_index=True, max_length=50, null=True)),
                ('english_last_name', models.CharField(blank=True, db_index=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_created_at', django_jalali.db.models.jDateTimeField(auto_now_add=True)),
                ('_updated_at', django_jalali.db.models.jDateTimeField(auto_now=True)),
                ('last_follow_up', models.DateTimeField(blank=True, db_index=True, null=True)),
                ...
                ('support_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='supported_users', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('_updated_at', django_jalali.db.models.jDateTimeField(auto_now=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('action', models.IntegerField(choices=[(1, 'تماس'), (2, 'پیام')], db_index=True, default=1)),
